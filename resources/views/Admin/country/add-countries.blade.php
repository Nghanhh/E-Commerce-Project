...
<div class="container-fluid">
    ...
    @csrf
        ...
        <button type="submit" style="background-color: #32CD32;color: white; border: none; padding: 10px 20px; margin-top: 10px; font-size: 15px; cursor: pointer;" >Add Country</button>
    </form>
    </div>  
</div>
