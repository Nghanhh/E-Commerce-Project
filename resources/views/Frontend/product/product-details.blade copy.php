	...
	<div class="product-details"><!--product-details-->
		...
		<div class="col-sm-5">
			<div class="view-product">
				<img class = "bigimg" src="{{asset('Frontend/images/product-details/1.jpg')}}" alt="" />
				<a href="{{asset('Frontend/images/product-details/new.jpg')}}" rel="prettyPhoto"><h3>ZOOM</h3></a>
			</div>
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						@foreach($imgarr as $value)
							<a href=""><img class = "smallimg" src="{{asset('upload/product/'.$imgarr['value])}}" alt=""></a>
						@endforeach
					</div>
					<!-- <div class="item">
